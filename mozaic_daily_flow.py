...
class MozaicDailyFlow(FlowSpec):
    ...
    # Check https://docs.metaflow.org/api/step-decorators/kubernetes for details on @kubernetes decorator
    @kubernetes(
        image="registry.hub.docker.com/brwells78094/mozaic-daily:v0.0.4_amd64", 
        cpu=1,
        memory=16384
    )
    @step
    def load(self):
        ...
        """
        print('load')
        print('This flow is using docker image: "registry.hub.docker.com/brwells78094/mozaic-daily:v0.0.4_amd64"')
